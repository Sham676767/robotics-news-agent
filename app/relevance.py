...
KEYWORDS: dict[str, tuple[str, ...]] = {
    "robotics": (
        ...
        "slam for robots", "robot arm", "robotic arm", "service robot",
        "social robot", "companion robot",
        ...
        "сервисный робот", "робот-манипулятор", "роботизированная рука",
        "социальный робот", "робот-компаньон",
    ),
    "robot_dog": (
