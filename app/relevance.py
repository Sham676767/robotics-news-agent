...
KEYWORDS: dict[str, tuple[str, ...]] = {
    "robotics": (
        ...
        "social robot", "companion robot", "educational robot", "robot platform",
        "physical ai robot", "physical ai robotics",
        ...
        "роботизированная рука", "коллаборативный робот", "социальный робот",
        "робот-компаньон", "образовательный робот", "робот-платформа",
    ),
    "robot_dog": (
